...
<h3 class="bg-primary-default"><?php echo __('Path Requests', 'devyai'); ?></h3>
<div class="container">
    <div class="table-responsive">
        <table class="shop_table shop_table_responsive my_account_orders">
            ...
            <tr style="background: #6d89af;">
                ...
                <th><?php echo __('Path Request','devyai')?></th>
                <th><?php echo __('Status','devyai')?></th>
            </tr>
            </thead>
            ...
            <?php if (!empty($entries)):
                ...
                <tr>
                    <td><?php echo __('You have no path requests','devyai')?></td>
                </tr>
            <?php endif; ?>
            </tbody>
        </table>
